<?php 
    ...
    $obj = new StudyMeet();
    $result=$obj->getmst_mst_question(array('user_id' => 1,'user_type' => 1, ));
?>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_title">
                <ul class="nav navbar-right panel_toolbox">
                    <li><a href="<?php echo 'add_question_post.php';?>"><i class="fa fa-plus"></i> Add Quetion/Post</a></li>
                </ul>
                <div class="clearfix"></div>
            </div>
                     ...
                     <tr>
                        ...
                        <td>
                            ...
                            <?php if ($results->post_type!="1") { ?>
                                    <a href="<?php echo ADMIN_URL.'Qu_An_List.php?id='.base64_encode($results->question_id).'&by=admin'; ?>" class="btn btn-primary">See All Answer</a>
                                    <a href="<?php echo ADMIN_URL.'Que_comment_list.php?id='.base64_encode($results->question_id).'&by=admin'; ?>" class="btn btn-primary">See All Comment</a>
                            <?php } ?>
                            <a href="<?php echo ADMIN_URL.'add_question_post.php?id='.base64_encode($results->question_id); ?>" class="btn btn-primary">Edit</a>
                        </td>
                      <?php } ?>
                     </tr>
                    <?php } ?>
